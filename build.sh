...
function xx-fix-product-ids () {
    ...
    # Win
    $GSED -si "s/zoteroWinWordIntegration@zotero.org/jurismWindWordIntegration@juris-m.github.io/g" install.rdf
...
function xx-fix-product-name () {
    ...
    $GSED -si "/Copyright.*Zotero/n;/Zotero *=/n;s/Zotero\( \|\"\|$\)/Juris-M\\1/g" components/zoteroMacWordIntegration.js
    $GSED -si "/Copyright.*Zotero/n;/Zotero *=/n;s/Zotero\( \|\"\|$\)/Juris-M\\1/g" components/zoteroMacWordIntegration2016Pipe.js
...
function xx-fix-uuids () {
    $GSED -si "s/aa56c6c0-95f0-48c2-b223-b11b96b9c9e5/4D06FB64-2DDD-11E5-9A06-31DA1D5D46B0/g" chrome.manifest
    $GSED -si "s/aa56c6c0-95f0-48c2-b223-b11b96b9c9e5/4D06FB64-2DDD-11E5-9A06-31DA1D5D46B0/g" components/zoteroMacWordIntegration.js
    $GSED -si "s/ea584d70-2797-4cd1-8015-1a5f5fb85af7/5684D472-2DDD-11E5-B567-32DA1D5D46B0/g" chrome.manifest
    $GSED -si "s/ea584d70-2797-4cd1-8015-1a5f5fb85af7/5684D472-2DDD-11E5-B567-32DA1D5D46B0/g" components/zoteroMacWordIntegration.js
    $GSED -si "s/9c6e787b-27d7-4567-98d4-b57d0afa3d8c/6051A408-2DDD-11E5-9064-8ADA1D5D46B0/g" chrome.manifest
    $GSED -si "s/9c6e787b-27d7-4567-98d4-b57d0afa3d8c/6051A408-2DDD-11E5-9064-8ADA1D5D46B0/g" components/zoteroMacWordIntegration.js
    $GSED -si "s/b063dd87-5615-45c5-ac3d-4b0583034616/68DE1872-2DDD-11E5-B1F2-8EDA1D5D46B0/g" chrome.manifest
    $GSED -si "s/b063dd87-5615-45c5-ac3d-4b0583034616/68DE1872-2DDD-11E5-B1F2-8EDA1D5D46B0/g" components/zoteroMacWordIntegration.js
    $GSED -si "s/26522064-b955-4bb0-9ccb-37a5c8c96fa0/716558F2-2DDD-11E5-8D23-8FDA1D5D46B0/g" chrome.manifest
    $GSED -si "s/26522064-b955-4bb0-9ccb-37a5c8c96fa0/716558F2-2DDD-11E5-8D23-8FDA1D5D46B0/g" components/zoteroMacWordIntegration2016Pipe.js
}

function xx-fix-install () {
    # Name everywhere (twice per customer)
    $GSED -si "s/\(\"[^\"]*\)Zotero\( \|\"\)/\\1Juris-M\\2/g" resource/installer.jsm
    $GSED -si "s/\(\"[^\"]*\)Zotero\( \|\"\)/\\1Juris-M\\2/g" resource/installer.jsm
    # ID everywhere
    ...
    # URLs
    $GSED -si "s/\(url: *\"\)\([^\"]*\)/\\1juris-m.github.org\/downloads/g" resource/installer.jsm
    $GSED -si "s/zoteroMacWordIntegration@zotero.org/jurismMacWordIntegration@juris-m.github.io/g" resource/installer.jsm
}
...
function xx-insert-copyright-blocks () {
    ...
    $GSED -si "/BEGIN LICENSE/r ../additives/copyright_block.txt" components/zoteroMacWordIntegration.js
    $GSED -si "/END OF INSERT/,/END LICENSE/d" components/zoteroMacWordIntegration.js
}
